#!/bin/bash
export PATH=/cpfs01/shared/public/users/lidong/cuda/cuda-11.7/bin:$PATH
export LD_LIBRARY_PATH=/cpfs01/shared/public/users/lidong/cuda/cuda-11.7/lib64:$LD_LIBRARY_PATH
